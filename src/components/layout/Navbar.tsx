...
export default function Header() {
  ...
  return (
    <header className="bg-[#FEF6F3] px-4 py-0 shadow-md" style={{ minHeight: '90px' }}>
      <div className="max-w-7xl h-[90px] mx-auto flex items-center justify-between gap-3">
        {/* Logo */}
        ...
        <div className="flex items-center flex-shrink-0 max-[670px]:block lg:hidden">
          <button
            ...
            className="text-2xl"
          >
            {isMenuOpen ? <IoCloseOutline size={36} /> : <HiMenu size={36} />}
          </button>
        </div>
      </div>
